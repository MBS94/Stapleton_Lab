...
# Create a R object. Was used for debugging from a previous problem.
...
# Code from a vQTL function that Thomas pulled from.
# Cannot remember what the function is called yet. 
# Will look into that at a later time.
########
...
# I believe this block of code is dropping observations that were not useful.
...
# Stitching together output from scanonevar and effectsizes function.
