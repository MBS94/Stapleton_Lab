---
title: "2018-08-03 Stapleton qPCR"
author: "Michael Byrd"
...
```{r}
hex <- read.csv(file = "2018_8_3_plate.csv")
```
...
colnames(eff.frame) = colnames(hex)[-c(1,201)]; rownames(eff.frame) = c("cpD1","cpD2")
...
write.csv(temp, file= "2018_08_03_plate_qPCR_output_2019_05_19.csv")
```